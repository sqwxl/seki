    ...
    return JSON.stringify(
      {
        analysis: {
          ...
          scoreSource: result.analysis.scoreSource,
          ownershipScoreMean: result.analysis.ownershipScoreMean,
          rawScoreMean: result.analysis.rawScoreMean,
    ...
    return JSON.stringify(
      {
        directPolicy: {
          ...
          scoreSource: result.directPolicy.scoreSource,
          ownershipScoreMean: result.directPolicy.ownershipScoreMean,
          rawScoreMean: result.directPolicy.rawScoreMean,

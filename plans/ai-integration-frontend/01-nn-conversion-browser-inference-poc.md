...
3. `kata9x9-b18c384nbt-20231025`
   ...
   - Why keep: strong dedicated 9x9 candidate and useful if first product scope
     targets 9x9.
   - Risk: too large as a download, not useful for 13x13 or 19x19.
   - Current result: official KataGo `OnnxModelBuilder` exports this model to a
     105,526,431 byte fixed-9x9 ONNX file with the same
     `InputMask`/`InputSpatial`/`InputGlobal` IO shape as the 19x19 Lionffen
     export. The artifact is ignored by git and generated by

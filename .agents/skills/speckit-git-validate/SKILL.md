...
Validate that the current Git branch follows this repository's development policy:
use `main` unless the user explicitly requested a feature branch for the current
task.
